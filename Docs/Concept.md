...
30. Возможные профили островов-столиц:
    ...
    Спираль (вид сбоку) | Лепестки (вид сверху) | Чаша (вид сбоку)
    --- | --- | ---
    ![Спираль](http://i.imgur.com/4kQRPZM.png) | ![Лепестки](http://i.imgur.com/rvmQtwI.png) | ![Чаша](http://i.imgur.com/oW8aehw.png)
